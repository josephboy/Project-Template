...
uint8_t CAN_Transmit(CAN_TypeDef* CANx, CanTxMsg* TxMessage)
{
  ...
  if (transmit_mailbox != CAN_TxStatus_NoMailBox)
  {
   ...
   /* Set up the data field */
    CANx->sTxMailBox[transmit_mailbox].TDLR = (((int32_t)TxMessage->Data[3] << 24) |
                                             ((int32_t)TxMessage->Data[2] << 16) |
                                             ((int32_t)TxMessage->Data[1] << 8) | 
                                             ((int32_t)TxMessage->Data[0]));
    CANx->sTxMailBox[transmit_mailbox].TDHR = (((int32_t)TxMessage->Data[7] << 24) | 
                                             ((int32_t)TxMessage->Data[6] << 16) |
                                             ((int32_t)TxMessage->Data[5] << 8) |
                                             ((int32_t)TxMessage->Data[4]));
